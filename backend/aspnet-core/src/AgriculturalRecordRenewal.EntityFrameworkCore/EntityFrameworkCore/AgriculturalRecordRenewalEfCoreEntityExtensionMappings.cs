...
public static class AgriculturalRecordRenewalEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AgriculturalRecordRenewalModuleExtensionConfigurator CLASS (in the Domain.Shared project)
